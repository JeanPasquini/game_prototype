...
audio_special_attack_flood_tentacle_bubble = scr_make_onetime_sound([
sde_enemy_psicotopus_special_attack_flood_tentacle_bubble1,
sde_enemy_psicotopus_special_attack_flood_tentacle_bubble2,
sde_enemy_psicotopus_special_attack_flood_tentacle_bubble3,
sde_enemy_psicotopus_special_attack_flood_tentacle_bubble4
], emitterAudio);